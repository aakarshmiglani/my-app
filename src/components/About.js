...
export default function About() {
  ...
  return (
    <div className='container' style={myState}>
        ...
        <div className="accordion-item" style={myState}>
            <h2 className="accordion-header">
            <button className="accordion-button collapsed" style={myState} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                Accordion Item #3
            </button>
            </h2>
